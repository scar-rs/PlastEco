...
$sql ="SELECT ID FROM tblvolunteer WHERE ID=:did and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblvolunteer set Password=:newpassword where ID=:did";
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Change Password</title>
