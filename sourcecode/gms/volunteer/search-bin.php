...
<head>
    ...
    <title>Plastic Waste Management System: Search Plastic Waste Bin</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Search Assign Bin</a>
            </nav>
...
$sql="SELECT * from  tblbin where BinID like '%$sdata%' && VolunteerAssignee=:did";
