...
<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        ...
        <a href="dashboard.php" class="navbar-brand"><strong>Plastic Waste</strong> Management System</a>
        <div id="navbar_main">
...
$sql="SELECT * from tblbin  where Status='Approved' && VolunteerAssignee=:did";
...
?>
                            ...
                            <h5 class="heading h6 mb-0">Plastic Waste Bin Notifications <span class="badge badge-pill badge-primary text-uppercase float-right"><?php echo $totalreq;?></span></h5>
                        </div>
  ...
  ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <h6 class="dropdown-header">Volunteer menu</h6>
