        ...
        <nav class="sidebar">
            <div class="user-info">
                ...
                <div class="detail mt-3">
                    ...
                    $sql="SELECT Name,Email from  tblvolunteer where VolunteerID=:did";
...
$fname=$row->Name;     
            ...
            <ul id="main-menu" class="metismenu">
               ...
               <li>
                ...
                <li>
                    <a href="javascript:void(0)" class="has-arrow"><i class="ti-pencil-alt"></i><span>Assign Plastic Waste Bin</span></a>
                    <ul>
                        <li><a href="new-request.php">New Plastic Waste Bin</a></li>
                        <li><a href="ontheway.php">On the way Plastic Waste Bin</a></li>
                        <li><a href="completed.php">Completed Plastic Waste Bin</a></li>
                        <li><a href="total-request.php">Total Plastic Waste Bin</a></li>
                ...
                <li class="open-top"><a href="ngo.php"><i class="ti-home"></i><span>Go to NGO site</span></a></li>
            </ul>            
        </nav>
    </div>