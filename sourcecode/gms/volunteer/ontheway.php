...
<head>
    ...
    <title>Plastic Waste Management System: Volunteer is on the way for cleaning bin</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Volunteer is on the way for cleaning bin</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Volunteer is on the way for cleaning bin </h2>
                            </div>
                            <div class="body">
