...
<head>
    ...
    <title>Plastic Waste Management System: Assign Plastic Waste Bin</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Assign Plastic Waste Bin</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Assign</strong> Plastic Waste Bin </h2>
                            </div>
                            <div class="body">
...
$sql="SELECT * from  tblbin where Status is null && VolunteerAssignee=:did";
