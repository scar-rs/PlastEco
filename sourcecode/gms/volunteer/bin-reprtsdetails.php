...
<head>
    ...
    <title>Plastic Waste Management System: View Task Competed Report For Bin</title>
...
where tblbin.VolunteerAssignee=:did && date(AssignDate) between '$fdate' and '$tdate'";
