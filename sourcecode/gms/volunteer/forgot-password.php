...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblvolunteer WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblvolunteer set Password=:newpassword where Email=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>Plastic Waste Management System: Forgot Password</title>
