...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID, VolunteerID FROM tblvolunteer WHERE VolunteerID=:did and Password=:password";
...
$_SESSION['vamsdid']=$result->VolunteerID;
...
<head>
    ...
    <title>Plastic Waste Management System: Login</title>
