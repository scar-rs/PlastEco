...
if (strlen($_SESSION['vamsid']==0)) {
  ...
  $sql="update tblvolunteer set Name=:name,MobileNumber=:mobilenumber,Email=:email,Address=:address where ID=:did";
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Profile</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Volunteer Profile</a>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="" method="post" novalidate>
                                    <?php
$did=$_SESSION['vamsid'];
$sql="SELECT * from  tblvolunteer where ID=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                                    <div class="form-group">
                                        <label>Your ID</label>
                                        <input type="text" class="form-control" id="exampleTextInput1" name="" value="<?php  echo $row->VolunteerID;?>" readonly='true'>
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
