...
$fname=$row->FullName;     
            ...
            <ul id="main-menu" class="metismenu">
               ...
               <li><a href="lodged-complain.php"><i class="ti-files"></i><span>lodged Complain</span></a></li>
                <li><a href="lodged-complain-history.php"><i class="ti-files"></i><span>Complain History</span></a></li>
