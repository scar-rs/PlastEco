...
?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon sales">
                        <div class="body" style="border:solid #000 1px">
                            <?php 
                        $sql1 ="SELECT * from  tblvolunteer";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totvolunteer=$query1->rowCount();
?>
                            <h6>Total Volunteers</h6>
                            <h2><?php echo htmlentities($totvolunteer);?></h2>
                           <a href="manage-volunteer.php"><small> View Detail</small></a>
                        </div>
                    </div>
                </div>
               <div class="col-lg-3 col-md-6 col-sm-12">
