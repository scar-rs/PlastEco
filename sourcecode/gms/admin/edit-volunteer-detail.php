...
$sql="update tblvolunteer set Name=:name,MobileNumber=:mobnum,Email=:email,Address=:address where ID=:eid";
...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  ...
  echo '<script>alert("Volunteer detail has been updated")</script>';
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Update Volunteer</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Update Volunteer</a>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="" method="post" novalidate>
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT * from  tblvolunteer where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driid" value="<?php  echo htmlentities($row->VolunteerID);?>" readonly='true' maxlength="10">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
