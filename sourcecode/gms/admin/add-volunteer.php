...
$ret="select Email from tblvolunteer where Email=:email || MobileNumber=:mobnum || VolunteerID=:driid";
...
$sql="insert into tblvolunteer(VolunteerID,Name,MobileNumber,Email,Address,Password)values(:driid,:name,:mobnum,:email,:address,:password)";
...
$query->bindParam(':password',$password,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Volunteer detail has been added.")</script>';
echo "<script>window.location.href ='add-volunteer.php'</script>";
  }
  else
    {
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Add Volunteer</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Add Volunteer</a>
