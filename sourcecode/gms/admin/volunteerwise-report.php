...
<head>
    ...
    <title>Plastic Waste Management System: Between dates Report of Cleaning Bin</title>
            ...
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Volunteerwise Between dates Report of Cleaning Bin </h2>
                            </div>
                            
                            <div class="body">
                                <form id="basic-form" method="post" action="volunteerwise-reportsdetails.php">
