...
<head>
    ...
    <title>Plastic Waste Management System: B/W Dates Lodged Complain Report</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">B/W Dates Lodged Complain Report</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>B/W Dates Lodged Complain Report </h2>
                            </div>
