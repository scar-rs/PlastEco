...
$sql="insert into tblbin(BinID,Area,Locality,Landmark,LoadType,CyclePeriod,Address,VolunteerAssignee)values(:binid,:area,:locality,:landmark,:loadtype,:cycleperiod,:address,:assignee)";
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Add Bin</title>
...
<option value="<?php echo htmlentities($row->VolunteerID);?>"><?php echo htmlentities($row->VolunteerID
    );?></option>
 <?php } ?>
    </select>
                                    </div>
