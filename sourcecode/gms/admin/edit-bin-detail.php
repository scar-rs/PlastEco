...
$sql="update tblbin set Area=:area,Locality=:locality,Landmark=:landmark,LoadType=:loadtype,CyclePeriod=:cycleperiod,Address=:address, VolunteerAssignee=:assignee where ID=:eid";
...
<html lang="en">
<head>
<title>Plastic Waste Management System: Update Bin Details</title>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="" method="post" novalidate>
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT tblvolunteer.ID,tblvolunteer.VolunteerID,tblbin.ID,tblbin.* from  tblbin join tblvolunteer on tblvolunteer.VolunteerID=tblbin.VolunteerAssignee where tblbin.ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
        ...
        <option value="<?php  echo $row->VolunteerAssignee;?>"><?php  echo $row->VolunteerAssignee;?></option>
        <?php 

$sql2 = "SELECT * from   tblvolunteer ";
...
<option value="<?php echo htmlentities($row2->VolunteerID);?>"><?php echo htmlentities($row2->VolunteerID
    );?></option>
 <?php } ?>
    </select>
                                    </div>
