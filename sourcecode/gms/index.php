...
<head>
    <meta charset="utf-8">
    <title>Plastic Waste Management System || Home Page</title>
...
{               ?>      
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">Plastic Waste Management System</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="volunteer/login.php" class="nav-item nav-link">Volunteer</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To Plastic Waste Management System</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Best Plastic Waste Management Services</h1>
...
{               ?>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a class="btn btn-link" href="volunteer/login.php">Volunteer</a>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Plastic Waste Management System</a>, All Right Reserved.
                    </div>
